                        ...
                        if (!dbContext.TeamMemberLinks.Any())
                        {
                            dbContext.AddRange(
                                new TeamMemberLink
                                {
                                    ...
                                    TargetUrl =
                                        "https://www.youtube.com/watch?v=8kCnOqvmEp0&ab_channel=JL%7C%D0%AE%D0%9B%D0%86%D0%AF%D0%9B%D0%A3%D0%A9%D0%98%D0%9D%D0%A1%D0%AC%D0%9A%D0%90",
                                    TeamMemberId = 1,
                                },
                                new TeamMemberLink
                                {
                ...
                if (!dbContext.Streetcodes.Any())
                {
                    ...
                    if (!dbContext.Subtitles.Any())
                    {
                        dbContext.Subtitles.AddRange(
                            ...
                            {
                                SubtitleText =
                                    "Developers: StreedCodeTeam, made with love and passion, some more text, and more text. Streetcode1",
                                StreetcodeId = 1
                            },
                            new Subtitle
                            {
                                SubtitleText =
                                    "Developers: StreedCodeTeam, made with love and passion, some more text, and more text. Streetcode2",
                                StreetcodeId = 2
                            });
                    ...
                    if (!dbContext.Videos.Any())
                    {
                        dbContext.Videos.AddRange(
                            ...
                            {
                                Title = "video1",
                                Description = "Біографія Т.Г.Шевченка",
                                Url =
                                    "https://www.youtube.com/watch?v=VVFEi6lTpZk&ab_channel=%D0%9E%D1%81%D1%82%D0%B0%D0%BD%D0%BD%D1%96%D0%B9%D0%93%D0%B5%D1%82%D1%8C%D0%BC%D0%B0%D0%BD",
                                StreetcodeId = 1
                            },
                            new Video
                            {
                                Title = "video2",
                                Url =
                                    "https://www.youtube.com/watch?v=YuoaECXH2Bc&ab_channel=%D0%A2%D0%B2%D0%BE%D1%8F%D0%9F%D1%96%D0%B4%D0%BF%D1%96%D0%BB%D1%8C%D0%BD%D0%B0%D0%93%D1%83%D0%BC%D0%B0%D0%BD%D1%96%D1%82%D0%B0%D1%80%D0%BA%D0%B0",
                                StreetcodeId = 2
                            });
                    ...
                    if (!dbContext.Partners.Any())
                    {
                        dbContext.Partners.AddRange(
                            ...
                            {
                                IsKeyPartner = true,
                                Title = "SoftServe Академія",
                                Description = "Підрозділ Центру Розвитку талантів в SoftServe Університеті",
                                LogoId = 5,
                            ...
                            new Partner
                            {
                                Title = "Український інститут національної пам'яті",
                                Description =
                                    "Центральний орган виконавчої влади, діяльність якого спрямовується та координується Кабінетом Міністрів України через Міністра культури та інформаційної політики і який реалізує державну політику у сфері відновлення та збереження національної пам’яті Українського народу. \r\nДжерело: «Стріткод: історія на кожному кроці» https://streetcode.com.ua",
                                LogoId = 6,
                                TargetUrl = "https://www.uinp.gov.ua"
                            },
                            new Partner
                            {
                                ...
                                LogoId = 7,
                                TargetUrl =
                                    "https://partners.salesforce.com/pdx/s/?language=en_US&redirected=RGSUDODQUL"
                            });
                    ...
                    if (!dbContext.Arts.Any())
                    {
                        dbContext.Arts.AddRange(
                            new Art
                            {
                                ...
                                Description =
                                    "«Козаки на орбіті» поєднує не тільки тему козаків, а й апелює до космічної тематики."
                            },
                            new Art
                            {
                                ImageId = 9,
                            ...
                            new Art
                            {
                                ...
                                Title = "Назар Дубів",
                                Description =
                                    "Назар Дубів опублікував серію малюнків, у яких перетворив класиків української літератури та політичних діячів на сучасних модників"
                            },
                            new Art
                            {
                                ImageId = 11,
                    ...
                    if (!dbContext.Texts.Any())
                    {
                        dbContext.Texts.AddRange(
                            ...
                            new Text
                            {
                                ...
                                TextContent =
                                    @"Тарас Шевченко народився 9 березня 1814 року в селі Моринці Пединівської волості Звенигородського повіту Київської губернії. Був третьою дитиною селян-кріпаків Григорія Івановича Шевченка та Катерини Якимівни після сестри Катерини (1804 — близько 1848) та брата Микити (1811 — близько 1870). За родинними переказами, Тарасові діди й прадіди з батьківського боку походили від козака Андрія, який на початку XVIII століття прийшов із Запорізької Січі. Батьки його матері, Катерини Якимівни Бойко, були переселенцями з Прикарпаття. 1816 року сім'я Шевченків переїхала до села Кирилівка Звенигородського повіту, звідки походив Григорій Іванович. Дитячі роки Тараса пройшли в цьому селі. 1816 року народилася Тарасова сестра Ярина, 1819 року — сестра Марія, а 1821 року народився Тарасів брат Йосип. Восени 1822 року Тарас Шевченко почав учитися грамоти у дяка Совгиря. Тоді ж ознайомився з творами Григорія Сковороди. 10 лютого 1823 року його старша сестра Катерина вийшла заміж за Антона Красицького — селянина із Зеленої Діброви, а 1 вересня 1823 року від тяжкої праці й злиднів померла мати Катерина. 19 жовтня 1823 року батько одружився вдруге з удовою Оксаною Терещенко, в якої вже було троє дітей. Вона жорстоко поводилася з нерідними дітьми, зокрема з малим Тарасом. 1824 року народилася Тарасова сестра Марія — від другого батькового шлюбу. Хлопець чумакував із батьком. Бував у Звенигородці, Умані, Єлисаветграді (тепер Кропивницький). 21 березня (2 квітня) 1825 року батько помер, і невдовзі мачуха повернулася зі своїми трьома дітьми до Моринців. Зрештою Тарас змушений був залишити домівку. Деякий час Тарас жив у свого дядька Павла, який після смерті його батька став опікуном сиріт. Дядько Павло був «великий катюга»; Тарас працював у нього, разом із наймитом у господарстві, але у підсумку не витримав тяжких умов життя й пішов у найми до нового кирилівського дяка Петра Богорського. Як попихач носив воду, опалював школу, обслуговував дяка, читав псалтир над померлими і вчився. Не стерпівши знущань Богорського й відчуваючи великий потяг до живопису, Тарас утік від дяка й почав шукати в навколишніх селах учителя-маляра. Кілька днів наймитував і «вчився» малярства в диякона Єфрема. Також мав учителів-малярів із села Стеблева, Канівського повіту та із села Тарасівки Звенигородського повіту. 1827 року він пас громадську отару в Кирилівці й там зустрічався з Оксаною Коваленко. Згодом подругу свого дитинства поет не раз згадає у своїх творах і присвятить їй поему «Мар'яна-черниця».",
                    ...
                    if (!dbContext.TimelineItems.Any())
                    {
                        dbContext.TimelineItems.AddRange(
                            ...
                            new TimelineItem
                            {
                                ...
                                Title = "Народився",
                                Description =
                                    "Цього дня Роман народився в Києві. В родині активіста руху проти знищення історичної забудови «Збережи старий Київ», добровольця Тараса Ратушного та письменниці, журналістки Світлани Поваляєвої. Зростав та вчився у столиці.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Description =
                                    "Коли прийшов час обирати фах, Роман зупиняє свій вибір на юридичному та вступає до Фінансово-правового коледжу в Києві.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Description =
                                    "Роману — 15. Україні — 22. І обох непокоїть несправедливість. Починається Революція гідності. Юний Ратушний — один з перших її учасників в усіх найгарячіших епізодах протистояння. У ніч на 30 листопада його разом з іншими студентами вперше побив «Беркут».",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Title = "«Знаю, що роблю»",
                                Description =
                                    "Під час штурму Євромайдану силовиками Роман хоч і постраждав, але вистояв разом з іншими гідними. «Тато. Знаю, що я роблю», — спокійно відповідає батькові та йде туди, де найгарячіше.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                            ...
                            new TimelineItem
                            {
                                ...
                                Description =
                                    "Роман очолює ініціативу «Захистимо Протасів Яр», з 2019 року це однойменна громадська організація. Разом з однодумцями активно виступає за збереження зеленої зони у Протасовому Яру в центрі Києва та проти побудови багатоповерхівок на зелених схилах.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Title = "Погрози",
                                Description =
                                    "Через погрози фізичною розправою та викраденням, про які Роман заявив у жовтні 2019-го, йому доводиться деякий час переховуватися.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Description =
                                    "Конфлікт та протистояння забудовнику ТОВ «Дайтона Груп» в суді нарешті закінчуються перемогою активістів на чолі з Ратушним. 27 червня 2020 року Київська міська рада повертає земельній ділянці площею 3,25 га у Протасовому Яру статус зелених насаджень.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                            ...
                            new TimelineItem
                            {
                                ...
                                Description =
                                    "Свій Протасів та свій Київ з початком повномасштабного вторгнення Росії Роман добровольцем захищає у лавах Збройних сил України в підрозділі «Протасового Яру». Спершу була Київщина, потім — Сумщина, де він брав участь у деокупації населених пунктів області, зокрема Тростянця.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Title = "Холодний Яр",
                                Description =
                                    "На початку квітня вступає до розвідувального взводу 2-го мотопіхотного батальйону 93-ї окремої механізованої бригади ЗСУ «Холодний Яр». Цей батальйон обороняв українську землю в Харківській області, зокрема в районі Ізюму.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Title = "Завжди 24",
                                Description =
                                    "Роман Ратушний не дожив трохи менше місяця до своїх 25 років. 9 червня 2022-го під Ізюмом на Харківщині він загинув, потрапивши у ворожу засідку. До кінця на бойовому завданні, вистежуючи ворожий танк. Тіло Романа декілька днів було на непідконтрольній території, доки його командир з позивним Боб зміг його забрати. Чекав сильної грози, щоб не бути поміченим ворогом.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Description =
                                    "Романа Ратушного поховали на Байковому кладовищі в Києві. Попрощатися прийшли сотні людей. Батьки, родичі, військові, знайомі та друзі Романа, громадяни, активісти, представники влади. Прощалися з героєм у Михайлівському соборі та на Майдані. Перед похороном над труною з його тілом розгорнули прапор України.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Description =
                                    "На засіданні Київради одноголосно підтримали перейменування вулиці Волгоградської у Солом'янському районі столиці на вулицю Романа Ратушного. Таку пропозицію подав письменник Євген Лір.",
                                StreetcodeId = 2
                            },
                            new TimelineItem
                            {
                                ...
                                Title = "За мужність",
                                Description =
                                    "Романа Ратушного посмертно нагородили орденом «За мужність» III ступеня — за особисту мужність і самовіддані дії, виявлені у захисті державного суверенітету та територіальної цілісності України, вірність військовій присязі.",
                                StreetcodeId = 2
                            });
                    ...
                    if (!dbContext.Facts.Any())
                    {
                        dbContext.Facts.AddRange(
                            new Fact
                            {
                                ...
                                FactContent =
                                    "Навесні 1838-го Карл Брюллов і Василь Жуковський вирішили викупити молодого поета з кріпацтва. " +
                            ...
                            new Fact
                            {
                                Title = "Перший Кобзар",
                                FactContent =
                                    " Ознайомившись випадково з рукописними творами Шевченка й вражений ними, П. Мартос виявив до них великий інтерес." +
                            ...
                            new Fact
                            {
                                ...
                                FactContent =
                                    "Український журналіст, публіцист і письменник Вахтанг Кіпіані від імені «Історичної правди» ініціював заснування іменної премії Романа Ратушного для молодих авторів за публікації, що стосуються історії Києва. Гроші на започаткування премії дали батьки Романа.",
                                ImageId = 9,
                                StreetcodeId = 2
                            },
                            new Fact
                            {
                                ...
                                FactContent =
                                    "На честь Романа в Інституті права Київського національного університету імені Тараса Шевченка заснували стипендіальну програму для громадських активістів, які здобувають юридичну освіту.",
                                ImageId = 10,
                                StreetcodeId = 2
                            },
                            new Fact
                            ...
                            new Fact
                            {
                                ...
                                FactContent =
                                    "Романа можна вважати «хрещеним» Державного бюро розслідувань. У 2015 році він самостійно створив карту зв’язків російської та української мафій, засновану на відкритих даних. Підтримував розслідування злочинів. За його даними, таких взаємопов’язаних осіб було близько тисячі.",
                                ImageId = 8,
                                StreetcodeId = 2
                            },
                            new Fact
                            {
                                ...
                                FactContent =
                                    "За словами мами Романа, Світлани Поваляєвої, маленький громадянин Ратушний почав ходити на мітинги та протести із семи років. Першою суспільно корисною активністю стала Помаранчева революція. «Участь у політичних і соціальних процесах своєї держави має бути атрибутом життя кожного громадянина», — наголошував Роман.",
                                ImageId = 9,
                                StreetcodeId = 2
                            },
                            new Fact
                            ...
                            new Fact
                            {
                                Title = "Життєві плани",
                                FactContent =
                                    "Після Революції гідності в 2014 році під час подорожі Європою тато Романа делікатно просував йому, юнакові, обпаленому Майданом, ідею навчання в одному з європейських університетів. А Роман делікатно відмовився. «На цей момент мій життєвий план такого не передбачає», — відповів.",
                                ImageId = 7,
                                StreetcodeId = 2
                            },
                            new Fact
                            ...
                            new Fact
                            {
                                ...
                                FactContent =
                                    "Всі знали Ратушного як щедру та безкорисливу людину. Так, компенсацію Європейського суду з прав людини, яку він отримав як потерпілий від побиття студентів «Беркутом», Роман фактично повністю витратив на громаду та боротьбу за Протасів Яр.",
                                ImageId = 9,
                                StreetcodeId = 2
                            },
                            new Fact
                            ...
                            new Fact
                            {
                                Title = "Заповіт нам",
                                FactContent =
                                    "20 травня 2022 року, незадовго до загибелі, Роман на своїй сторінці у фейсбуці опублікував пост — свого роду заповіт нам. «Допоки Збройні сили вбивають русню на фронті, ви нездатні вбити русню в собі. Просто запам’ятайте: чим більше росіян ми вб’ємо зараз, тим менше росіян доведеться вбивати нашим дітям. Ця війна триває більше трьох сотень років…».",
                                ImageId = 7,
                                StreetcodeId = 2
                            },
                            new Fact
                            ...
                            new Fact
                            {
                                ...
                                FactContent =
                                    "У липні 2022 року в Лугано президентка Єврокомісії Урсула фон дер Ляєн під час конференції з відбудови України розпочала свій виступ словами про Романа, активіста та журналіста, який мріяв про Україну, вільну від корупції, та поклав життя за її суверенітет.",
                                ImageId = 9,
                                StreetcodeId = 2
                            },
                            new Fact
