...
BEGIN
    ...
    VALUES (N'20230622110726_Initial', N'7.0.13');
END;
GO
...
BEGIN
    ...
    IF @var4 IS NOT NULL EXEC(N'ALTER TABLE [streetcode].[streetcodes] DROP CONSTRAINT [' + @var4 + '];');
...
BEGIN
    ...
    IF @var5 IS NOT NULL EXEC(N'ALTER TABLE [jobs].[job] DROP CONSTRAINT [' + @var5 + '];');
