    ...
    public static class SeedingLocalExtension
    {
        public static async Task SeedDataAsync(this WebApplication app)
        {
            using (var scope = app.Services.CreateScope())
            {
                ...
                var repo = new RepositoryWrapper(dbContext, userManager, roleManager);
...
>>>>>>> bbea4e1b (Add Identity to Services; make roles and users database seeding if Roles table is empty)
                        {
                            Name = "Name one",
                            ImageId = 16,
                            Description = "У 1894 році Грушевський за рекомендацією Володимира Антоновича призначений\r\nна посаду ординарного професора",
                ...
                if (!dbContext.Streetcodes.Any())
                {
                    ...
                    if (!dbContext.Subtitles.Any())
                    {
                        dbContext.Subtitles.AddRange(
                            new Subtitle
                            {
                                SubtitleText = "Developers: StreedCodeTeam, made with love and passion, some more text, and more text. Streetcode1",
                                StreetcodeId = 1
                            },
                            new Subtitle
                            {
                                SubtitleText = "Developers: StreedCodeTeam, made with love and passion, some more text, and more text. Streetcode2",
                                StreetcodeId = 2
                            });
                    ...
                    if (!dbContext.Partners.Any())
                    {
                        dbContext.Partners.AddRange(
                            ...
                            new Partner
                            {
                                ...
                                Description = "Центральний орган виконавчої влади, діяльність якого спрямовується та координується Кабінетом Міністрів України через Міністра культури та інформаційної політики і який реалізує державну політику у сфері відновлення та збереження національної пам’яті Українського народу. \r\nДжерело: «Стріткод: історія на кожному кроці» https://streetcode.com.ua",
                                LogoId = 6,
