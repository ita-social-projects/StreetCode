    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ImageId = table.Column<int>(type: "int", nullable: false),
                    StreetcodeContentId = table.Column<int>(type: "int", nullable: false),
                    StreetcodeId = table.Column<int>(type: "int", nullable: false),
                    ImmageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_streetcode_image", x => new { x.ImageId, x.StreetcodeContentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_streetcode_image_streetcodes_StreetcodeContentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_streetcode_partners", x => new { x.PartnersId, x.StreetcodeContentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_streetcode_partners_streetcodes_StreetcodeContentId",
                        column: x => x.StreetcodeContentId,
                        principalSchema: "streetcode",
                        principalTable: "streetcodes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_timeline_item_historical_context", x => new { x.HistoricalContextId, x.TimelineItemId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_timeline_item_historical_context_timeline_items_TimelineItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_streetcode_image_StreetcodeContentId",
                schema: "streetcode",
                table: "streetcode_image",
                column: "StreetcodeContentId");

            migrationBuilder.CreateIndex(
                name: "IX_streetcode_partners_StreetcodeContentId",
                schema: "streetcode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_timeline_item_historical_context_TimelineItemId",
                schema: "timeline",
