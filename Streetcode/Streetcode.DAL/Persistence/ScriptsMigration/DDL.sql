...
IF NOT EXISTS(SELECT * FROM [entity_framework].[__EFMigrationsHistory] WHERE [MigrationId] = N'20230520003257_Initial')
BEGIN
...
BEGIN
    CREATE TABLE [timeline].[timeline_item_historical_context] (
        ...
        CONSTRAINT [PK_timeline_item_historical_context] PRIMARY KEY ([HistoricalContextId], [TimelineId]),
        CONSTRAINT [FK_timeline_item_historical_context_historical_contexts_HistoricalContextId] FOREIGN KEY ([HistoricalContextId]) REFERENCES [timeline].[historical_contexts] ([Id]) ON DELETE CASCADE,
        CONSTRAINT [FK_timeline_item_historical_context_timeline_items_TimelineId] FOREIGN KEY ([TimelineId]) REFERENCES [timeline].[timeline_items] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    ...
    VALUES (N'20230520003257_Initial', N'6.0.11');
END;
GO
