...
{
    private static readonly ConcurrentDictionary<Type, object> EntityLocks = new ();
        ...
        where T : class, new()
    {
        ...
        lock (EntityLocks.GetOrAdd(typeof(T), new object()))
        {
    ...
    public void AddItemWithCustomId<T>(T newItem)
        where T : class, new()
    {
        var entityLock = EntityLocks.GetOrAdd(typeof(T), new object());
