IF NOT EXISTS(SELECT * FROM [entity_framework].[__EFMigrationsHistory] WHERE [MigrationId] = N'20250119012155_UserUpdate')
BEGIN
...
BEGIN
    ...
    VALUES (N'20250119012155_UserUpdate', N'7.0.13');
END;
GO
