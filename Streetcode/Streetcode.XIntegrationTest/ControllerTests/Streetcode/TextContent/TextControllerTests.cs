...
{
    public class TextControllerTests : BaseControllerTests, IClassFixture<CustomWebApplicationFactory<Program>>
    {
        public TextControllerTests(CustomWebApplicationFactory<Program> factory) : base(factory)
        {
