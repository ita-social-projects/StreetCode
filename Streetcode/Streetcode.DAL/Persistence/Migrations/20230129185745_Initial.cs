        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "Мико́ла Костома́ров", "Мико́ла Костома́ров", "https://i.ibb.co/f85t1Vs/Antonovich.png" },
                    { 7, "Василь Білозерський", "Василь Білозерський", "https://i.ibb.co/f85t1Vs/Antonovich.png" },
                    { 8, "Роман Ратушний", "Роман Ратушний", "https://i.ibb.co/89KKcBD/Ratushny.png" },
                    ...
                    { 15, "Володимир-Варфоломей", "Володимир-Варфоломей", "https://i.ibb.co/RB9KtSq/Ukrainka.png" },
                    { 16, "Леся Українка", "Леся Українка", "https://i.ibb.co/RB9KtSq/Ukrainka.png" },
                    { 17, "Іван Мазепа", "Іван Мазепа", "https://i.ibb.co/YDjTGzW/Mazepa.png" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, new DateTime(2023, 1, 29, 20, 57, 44, 923, DateTimeKind.Local).AddTicks(9299), new DateTime(1899, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1825, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Володимир-Варфоломей", 5, "Кропивницький-Шевченківський", null, "streetcode-person", "some teaser", "Кропивницький-Шевченківський" },
                    { 6, new DateTime(2023, 1, 29, 20, 57, 44, 923, DateTimeKind.Local).AddTicks(9302), new DateTime(1899, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1825, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Леся", 6, "Українка", null, "streetcode-person", "some teaser", "Леся Українка" },
                    { 7, new DateTime(2023, 1, 29, 20, 57, 44, 923, DateTimeKind.Local).AddTicks(9306), new DateTime(1899, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1825, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Іван", 7, "Мазепа", null, "streetcode-person", "some teaser", "Іван Мазепа" }
                });
